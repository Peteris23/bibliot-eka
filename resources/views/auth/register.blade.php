...
<head>
    ...
    <title>Reģistrēties - Biblioteka</title>
...
<body class="bg-black text-white font-sans min-h-screen flex items-center justify-center">
    <div class="bg-gray-800 rounded-lg shadow-lg p-8 w-full max-w-md border border-purple-500">
        <h1 class="text-2xl font-bold text-center mb-6 text-purple-400">Reģistrēties Bibliotekā</h1>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                <label for="password" class="block text-sm font-medium text-gray-300">Parole</label>
                <input type="password" id="password" name="password" required
                       class="mt-1 block w-full rounded-md bg-white border-gray-300 text-black shadow-sm focus:border-purple-500 focus:ring-purple-500 px-3 py-2">
            </div>

            <div class="mb-6">
                <label for="password_confirmation" class="block text-sm font-medium text-gray-300">Apstiprināt Paroli</label>
